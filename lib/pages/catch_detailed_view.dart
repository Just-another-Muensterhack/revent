          ...
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return ListView(
              ...
              children: [
                ...
                cat.myStatus() == RequestStatus.pending ||
                        cat.myStatus() == RequestStatus.declined
                    ? TextButton(
                        onPressed: () async {
                          await cat.changeMyStatus(RequestStatus.accepted);
                          Navigator.pop(context);
                        },
                        child: Container(
                          color: Colors.white12,
                          ...
                          width: 100,
                          child: Center(
                            child: Text("Join Catch"),
                          ),
                        ),
                      )
                    : TextButton(
                        onPressed: () async {
                          await cat.changeMyStatus(RequestStatus.declined);
                          Navigator.pop(context);
                        },
                        child: Container(
                          color: Colors.white12,
