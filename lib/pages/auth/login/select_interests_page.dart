...
class _SelectInterestsPageState extends State<SelectInterestsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(appBar: imageAppBar(),
        body: Center(
            ...
            children: <Widget>[
              SizedBox(height: 200,
                  child:  ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) => Card(color: _cardsValue[index] ?
                      primary:  Colors.grey,
                      child: InkWell(onTap: (){
                          setState(() {
                        ...
                        child: Container(width: size.width * 0.25, child: Center(child: Text(
              ...
              Padding(
                ...
                child: CustomButton(buttonText: "Continue", onPress: () {
