                        ...
                        children: <Widget>[
                          ListTile(title: const Text("Account",
                              ...
                              trailing: IconButton(icon:
                                const Icon(Icons.arrow_right), color: Colors.white, onPressed: () => {

                              })),
                          ListTile(title: const Text("Friends", style: TextStyle(color: Colors.white)),
                          ...
                          // divider here pls :3
                          ListTile(title: const Text("Data & Privacy",
                              style: TextStyle(color: Colors.white)),
                              trailing: IconButton(icon: const Icon(Icons.arrow_right),
                                  color: Colors.white, onPressed: () => {})),
                          ListTile(title: const Text("Impressum",
                              style: TextStyle(color: Colors.white)),
                              trailing: IconButton(icon: const Icon(Icons.arrow_right),
                                  color: Colors.white, onPressed: () => {} ))
                        ]
